                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="card h-100">
                                    <div class="single-post post-style-1">
                                        ...
                                        <div class="blog-image"><img src="{{ Storage::disk()->url('post/'.$post->image) }}" alt="{{ $post->title }}"></div>

                                        <a class="avatar" href="{{ route('author.profile',$post->user->username) }}">
                                            <img src="{{ Storage::disk()->url('profile/'.$post->user->image) }}" alt="Profile Image"></a>
                                        <div class="blog-info">
                ...
                <div class="col-lg-4 col-md-12 ">
                    ...
                    <div class="single-post info-area ">
                        ...
                        <div class="about-area">
                            ...
                            <p>{{ $author->name }}</p><br>
                            <p>{{ $author->about }}</p><br>
                            <strong>Author Since: {{ $author->created_at ? $author->created_at->toDateString() : 'not set' }}</strong><br>
                            <strong>Total Posts : {{ $author->posts ? $author->posts->count() : 'No posts yet' }}</strong>
                        </div>
